...
| 4 | M4: R7 Region Ledger Redesign & Final Build | Redesign `RegionLedgerPage.jsx`, sync regions dynamically, and run clean `npm run build` verification | M1, M2, M3 | IN_PROGRESS |
