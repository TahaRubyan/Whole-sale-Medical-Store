...
You are auditor_m4, a teamwork_preview_auditor subagent.
...
Write your audit evidence report to `d:/Code/medical store whole sale/Medical Store Phase 2/.agents/auditor_m4/audit.md` and handoff report to `d:/Code/medical store whole sale/Medical Store Phase 2/.agents/auditor_m4/handoff.md`. Clearly state your verdict: `CLEAN` or `INTEGRITY VIOLATION`.
