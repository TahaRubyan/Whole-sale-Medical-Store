...
<USER_REQUEST>
You are auditor_m4_gen2, a teamwork_preview_auditor subagent (replacement for errored auditor_m4).
...
Write your audit evidence report to `d:/Code/medical store whole sale/Medical Store Phase 2/.agents/auditor_m4_gen2/audit.md` and handoff report to `d:/Code/medical store whole sale/Medical Store Phase 2/.agents/auditor_m4_gen2/handoff.md`. Clearly state your verdict: `CLEAN` or `INTEGRITY VIOLATION`.
