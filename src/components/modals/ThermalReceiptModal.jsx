        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem', fontSize: '0.725rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', color: '#64748B' }}>
              ...
              <span>+Rs. {Number(sale.totalSaleTax || calculations.totalSaleTax || 0).toFixed(2)}</span>
            </div>
            {Number(sale.totalAdvTax || calculations.totalAdvTax || 0) > 0 && (
              <div style={{ display: 'flex', justifyContent: 'space-between', color: '#64748B' }}>
                <span>Adv Tax (0.5%):</span>
                <span>+Rs. {Number(sale.totalAdvTax || calculations.totalAdvTax || 0).toFixed(2)}</span>
              </div>
            )}
