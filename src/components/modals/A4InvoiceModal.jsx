...
export const A4InvoiceModal = ({ sale, onClose }) => {
  ...
  const handlePrint = () => {
    printElementById('a4-invoice-container', `Invoice - ${sale.invoiceNo || 'Document'}`);
  };
  ...
  // Summary Totals Calculation (FBR Sales Tax 18% & Adv Tax 0.5%)
                ...
                <div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1.45fr 1fr', gap: '16px', borderBottom: '1px solid #000000', paddingBottom: '6px', marginBottom: '8px', fontSize: '7.5pt', lineHeight: '1.4' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5px' }}>
                      ...
                      <div><span style={{ width: '115px', display: 'inline-block', fontWeight: 'bold' }}>Customer Code:</span> {sale.customerId || sale.customerCode || '-'}</div>
                      <div><span style={{ width: '115px', display: 'inline-block', fontWeight: 'bold' }}>Customer Name:</span> <strong>{sale.customerName || '-'}</strong></div>
                      <div><span style={{ width: '115px', display: 'inline-block', fontWeight: 'bold' }}>Customer Address:</span> {sale.customerAddress || '-'}</div>
                      <div><span style={{ width: '115px', display: 'inline-block', fontWeight: 'bold' }}>Customer NTN/CNIC:</span> {sale.customerNtn || sale.customerCnic || '-'}</div>
                      <div><span style={{ width: '115px', display: 'inline-block', fontWeight: 'bold' }}>Customer STRN:</span> {sale.customerStrn || '-'}</div>
                  ...
                  {/* 2. ITEMIZED PRODUCTS TABLE (INCLUDING ADV TAX 0.5%) */}
